...
/**
 * Configuración de rutas HTTP usando RouterFunction (enfoque funcional de Spring WebFlux).
 * 
 * Cada ruta delega en un Handler, que a su vez invoca el UseCase.
 * Esta arquitectura preserva la separación de capas:
 *   HTTP Layer (RouterFunction) → API Layer (Handler) → Business Logic (UseCase) → Data (Gateway)
 * 
...
public class ApiRouterConfig {
    ...
    // TODO: Inyectar handlers de negocio aquí (ej: private final ProductHandler productHandler;)
