...
class BaseMongoGatewayImplTest {
    ...
    private final ReactiveMongoRepository<TestDocument, String> repository = mock(ReactiveMongoRepository.class);
    ...
    private static final class TestGateway
            extends BaseMongoGatewayImpl<TestDomain, TestDocument, ReactiveMongoRepository<TestDocument, String>> {
