package co.com.store.mongo;

import co.com.store.model.gateways.BaseGateway;
 ...
 * 3. Inyecta el repositorio y mapea datos entre entidad del modelo y documento
 * MongoDB
 * 
 ...
 */
public abstract class BaseMongoGatewayImpl<T, D, R extends ReactiveMongoRepository<D, String>>
        implements BaseGateway<T, String> {
