 ...
 * Demuestra cómo un caso de uso valida entrada, delega a un gateway
 * (repositorio)
...
public class CreateProductUseCase extends BaseUseCase {
     ...
     * 
     * @param productData Mapa con los datos del producto (nombre, descripción,
     *                    etc.)
     * @return Mono con el producto creado (incluye ID generado por la base de
     *         datos)
     */
